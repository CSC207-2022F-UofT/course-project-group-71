...
Furthermore, actions can be done on the result page.
- Show Notification: the notification is generated by actions either from organizations or sent by the system informing important alerts regarding changes in statuses of relevant events.
All notifications will appear together and can be only seen once.
- Account Page: the participant can choose to reset their password here.
- Upcoming Event Page: the participant can see all the upcoming events that are previously joined, can check event details, and can choose to leave events.
- Past Event Page: the participant can see the records of past events joined. Event details are still available to see, but the records cannot be removed.
- Followed Organization Page: the participant can see all the organizations they followed and can choose to unfollow any of them.

If the user is an organization, the home page will only have buttons that direct the user to other pages.
- Action Page: the organization can choose to reset their password here.
- Unpublished Event Page: the organization create, edit, delete new events here before publishing them.
- Upcoming Event Page: as the organization publishes an event, the event will be moved here.
The organization cannot edit the information of events anymore, but can choose to delete them.
Participants who joined deleted events will be informed of their deletion.
- Past Event Page: once the time of upcoming events have passed, they will be moved here.
All the events here can be seen as records and cannot be removed.
- Follower Page: the organization can see the usernames of followers.
The organization cannot remove followers.

In all places where an event title is shown, users can click on titles and see event details.

In all places where an organization username is shown, participants can click on them and see the organization's upcoming events.

We did not introduce the concept of price and budget to the system.
There is no cap for the number of people attending an events.
